<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Grupos.aspx.cs" Inherits="MSGRScroll.Vistas.Grupos" %>
...
<body>
    <form id="formGrupos" runat="server">
        <div>
            <div id="logo"></div>
            <table>
                <tr>
                    <td class="auto-style1">Nombre de grupo: </td>
                    <td>
